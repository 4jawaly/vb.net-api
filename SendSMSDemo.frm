...
Begin VB.Form SendSMSDemo 
   ...
   Begin VB.ListBox List2 
      Height          =   2205
      ItemData        =   "SendSMSDemo.frx":0000
      Left            =   9360
      List            =   "SendSMSDemo.frx":01BA
      TabIndex        =   11
      Top             =   3480
      Visible         =   0   'False
      Width           =   735
   ...
   Begin VB.ListBox List1 
      Height          =   2010
      ItemData        =   "SendSMSDemo.frx":0496
      Left            =   9360
      List            =   "SendSMSDemo.frx":0650
      TabIndex        =   10
      Top             =   1320
      Visible         =   0   'False
      Width           =   615
...
s = "http://www.oursms.net/api/addSender.php?username=" & UserName & "&password=" & Password & "&Sendername=" & TxtSenderName.Text
...
s = "http://www.oursms.net/api/sendsms.php?username=" & UserName & "&password=" & Password & "&message=" & msg & "&numbers=" & numbers & "&sender=" & sender & "&unicode=U"
...
s = "http://www.oursms.net/api/getbalance.php?username=" & UserName & "&password=" & Password
 result = Inet1.OpenURL(s)
Do While Inet1.StillExecuting
    DoEvents
Loop
